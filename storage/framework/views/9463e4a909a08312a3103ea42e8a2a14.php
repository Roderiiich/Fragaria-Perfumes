        ...
        <form method="POST" action="<?php echo e(route('register')); ?>">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input class="form-input" id="nombres" type="text" name="nombres" value="<?php echo e(old('nombres')); ?>" required autofocus placeholder="César">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <input class="form-input" id="apellidos" type="text" name="apellidos" value="<?php echo e(old('apellidos')); ?>" required placeholder="Mora">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group full-width">
                ...
                <input class="form-input" id="nickname" type="text" name="nickname" value="<?php echo e(old('nickname')); ?>" required placeholder="ejemplo: @cesarmora">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group full-width">
                ...
                <input class="form-input" id="email" type="email" name="email" value="<?php echo e(old('email')); ?>" required placeholder="tu@correo.com">
...
</html><?php /**PATH C:\Users\Rich\Desktop\fragaria\resources\views/perfumes/register.blade.php ENDPATH**/ ?>