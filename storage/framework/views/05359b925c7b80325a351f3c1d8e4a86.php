...
<head>
    ...
    <style>
        * {
        ...
        .btn-logout:hover { background-color: #111827; }
        ...
        .perfume-meta strong { color: #111827; }
        .meta-separator {
            margin: 0 8px;
            color: #d1d5db;
        }
                ...
                <div class="perfume-card">
                    ...
                    <div class="card-info">
                        ...
                        <div class="perfume-meta">
                            <span>Duración: <strong><?php echo e($perfume->duracion_promedio ? round($perfume->duracion_promedio) . ' horas' : 'Sin reseñas'); ?></strong></span>
                            <span class="meta-separator">|</span>
                            <span>Proyección: <strong>
                                <?php $proy = round($perfume->proyeccion_promedio ?? 0); ?>
                                <?php echo e($proy == 3 ? 'Intenso' : ($proy == 2 ? 'Moderado' : ($proy == 1 ? 'Leve' : 'Sin reseñas'))); ?>
                        ...
                        <div class="perfume-rating">
                            <span class="stars">
                                <?php $rating = $perfume->calificacion_promedio ? round($perfume->calificacion_promedio) : 0; ?>
                                <?php echo str_repeat('★', $rating); ?><?php echo str_repeat('☆', 5 - $rating); ?>

                            </span>
                            <span class="reviews-count">(<?php echo e($perfume->total_resenas); ?> reseñas)</span>
                        </div>
...
</html><?php /**PATH C:\xampp\htdocs\fragaria\resources\views/perfumes/index.blade.php ENDPATH**/ ?>