                ...
                <div class="perfume-card">
                    ...
                    <div class="card-info">
                        ...
                        <div class="perfume-meta">
                            <span>Duración: <strong>{{ $perfume->duracion_promedio ? round($perfume->duracion_promedio) . ' horas' : 'Sin reseñas' }}</strong></span>
                            <span class="meta-separator">|</span>
                            <span>Proyección: <strong>
                                @php $proy = round($perfume->proyeccion_promedio ?? 0); @endphp
                                {{ $proy == 3 ? 'Intenso' : ($proy == 2 ? 'Moderado' : ($proy == 1 ? 'Leve' : 'Sin reseñas')) }}
                            </strong></span>
                        </div>

                        <div class="perfume-rating">
                            <span class="stars">
                                @php $rating = $perfume->calificacion_promedio ? round($perfume->calificacion_promedio) : 0; @endphp
                                {!! str_repeat('★', $rating) !!}{!! str_repeat('☆', 5 - $rating) !!}
                            </span>
                            <span class="reviews-count">({{ $perfume->total_resenas }} reseñas)</span>
                        </div>
